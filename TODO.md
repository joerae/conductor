# TODO.md
[x] for the score display during spotlight mode - often some of the first bar runs over into the second bar, and the notes end up on top of each other. For example, measures 9 and 10 for the cello / bass. The quavers on beat 4 of measure 9 visually stack over the top of beat 1 of measure 10
...
[x] return after warmup. I don't think it needs any form of panel. Just straight into it. Or if it has a message, it's just "raise your hands to begin" like above
